...
const INITIAL_DATA = [
  ...
  { date: '2026-01-02', room: 'Pine', name: '박정아', phone: '01068882804', path: '네이버펜션', nights: 2, price: 480000, adults: 0, kids: 0 },
  ...
  { date: '2026-01-10', room: 'Pine', name: '정희나', path: '여기어때', nights: 1, price: 400000, adults: 0, kids: 0 },
  { date: '2026-01-11', room: 'Beach', name: '허소영', path: '여기어때', nights: 1, price: 180000, adults: 0, kids: 0 },
  ...
  { date: '2026-01-17', room: 'Pine', name: '민경복', path: '떠나요', nights: 1, price: 400000, adults: 0, kids: 0 },
  { date: '2026-01-22', room: 'Beach', name: '최미선', path: '여기어때', nights: 2, price: 400000, adults: 0, kids: 0 },
  { date: '2026-01-24', room: 'Shell', name: '이지', path: '여기어때', nights: 1, price: 120000, adults: 0, kids: 0 },
  { date: '2026-01-24', room: 'Beach', name: '이하은', path: '여기어때', nights: 1, price: 220000, adults: 0, kids: 0 },
  { date: '2026-01-24', room: 'Pine', name: '김현정', path: '여기어때', nights: 1, price: 400000, adults: 0, kids: 0 },
  { date: '2026-01-25', room: 'Shell', name: '진혜령', path: '떠나요', nights: 1, price: 100000, adults: 0, kids: 0 },
  { date: '2026-01-25', room: 'Beach', name: '문성권', path: '여기어때', nights: 1, price: 180000, adults: 0, kids: 0 },
  { date: '2026-01-31', room: 'Shell', name: '이광혁', path: '여기어때', nights: 1, price: 120000, adults: 0, kids: 0 },
  { date: '2026-01-31', room: 'Beach', name: '김태진', phone: '01094984844', path: '홈페이지', nights: 1, price: 220000, adults: 0, kids: 0 },
  { date: '2026-01-31', room: 'Pine', name: '김혜영', phone: '01041796875', path: '네이버지도', nights: 1, price: 420000, adults: 0, kids: 0 },
  { date: '2026-02-06', room: 'Pine', name: '박세진', phone: '01027593827', path: '네이버플레이스', nights: 1, price: 220000, adults: 0, kids: 0 },
  { date: '2026-02-07', room: 'Shell', name: '고명현', path: '떠나요', nights: 1, price: 120000, adults: 0, kids: 0 },
  { date: '2026-02-07', room: 'Beach', name: '강보미', path: '여기어때', nights: 1, price: 220000, adults: 0, kids: 0 },
  { date: '2026-02-07', room: 'Pine', name: '박진웅', path: '떠나요', nights: 1, price: 400000, adults: 0, kids: 0 },
  { date: '2026-02-08', room: 'Pine', name: '김성운', path: '여기어때', nights: 1, price: 220000, adults: 0, kids: 0 },
  { date: '2026-02-14', room: 'Shell', name: '김주호', phone: '01032130905', path: '네이버펜션', nights: 2, price: 255000, adults: 0, kids: 0 },
  { date: '2026-02-14', room: 'Beach', name: '허진보', phone: '01096607799', path: '네이버지도', nights: 1, price: 220000, adults: 0, kids: 0 },
  { date: '2026-02-14', room: 'Pine', name: '한행륜', path: '여기어때', nights: 1, price: 400000, adults: 0, kids: 0 },
  ...
  { date: '2026-02-16', room: 'Beach', name: '박기태', path: '여기어때', nights: 1, price: 220000, adults: 0, kids: 0 },
  { date: '2026-02-17', room: 'Beach', name: '최선희', path: '여기어때', nights: 2, price: 400000, adults: 0, kids: 0 },
  { date: '2026-02-21', room: 'Beach', name: 'Dongkyun J', path: '떠나요', nights: 1, price: 220000, adults: 0, kids: 0 },
  { date: '2026-02-22', room: 'Pine', name: '최춘경', phone: '01036823117', path: '네이버플레이스', nights: 1, price: 20000, adults: 0, kids: 0 },
  { date: '2026-02-27', room: 'Shell', name: '김승윤', path: '여기어때', nights: 1, price: 100000, adults: 0, kids: 0 },
  { date: '2026-02-28', room: 'Shell', name: '박미선', phone: '01052631253', path: '네이버펜션', nights: 2, price: 240000, adults: 0, kids: 0 },
  { date: '2026-02-28', room: 'Beach', name: '조민지', phone: '01056415280', path: '네이버플레이스', nights: 1, price: 240000, adults: 0, kids: 0 },
  ...
  { date: '2026-03-01', room: 'Beach', name: '장선희', path: '여기어때', nights: 1, price: 220000, adults: 0, kids: 0 },
  { date: '2026-03-07', room: 'Shell', name: '이주희', path: '떠나요', nights: 1, price: 120000, adults: 0, kids: 0 },
  { date: '2026-03-07', room: 'Beach', name: '추연희', path: '여기어때', nights: 1, price: 220000, adults: 0, kids: 0 },
  { date: '2026-03-07', room: 'Pine', name: '배윤혜', path: '떠나요', nights: 1, price: 400000, adults: 0, kids: 0 },
  ...
  { date: '2026-03-17', room: 'Pine', name: '이민호', path: '여기어때', nights: 1, price: 220000, adults: 0, kids: 0 },
  { date: '2026-03-18', room: 'Pine', name: '원재', path: '직접', nights: 1, price: 220000, adults: 0, kids: 0 },
  { date: '2026-03-21', room: 'Beach', name: '안성훈', phone: '01020033451', path: '떠나요', nights: 1, price: 220000, adults: 0, kids: 0 },
  { date: '2026-03-22', room: 'Shell', name: '박수헌', path: '직접', nights: 2, price: 240000, adults: 0, kids: 0 },
  { date: '2026-03-28', room: 'Shell', name: '박광수', phone: '01087676574', path: '네이버지도', nights: 1, price: 120000, adults: 0, kids: 0 },
  { date: '2026-04-04', room: 'Beach', name: '강홍석', phone: '01026554359', path: '네이버플레이스', nights: 1, price: 260000, adults: 0, kids: 0 },
  { date: '2026-04-04', room: 'Pine', name: '박준하', phone: '01049165910', path: '네이버플레이스', nights: 1, price: 415000, adults: 0, kids: 0 },
  { date: '2026-04-12', room: 'Pine', name: '엄마지인', path: '직접', nights: 1, price: 220000, adults: 0, kids: 0 },
  { date: '2026-04-17', room: 'Beach', name: 'YUN SANG J', path: '떠나요', nights: 1, price: 180000, adults: 0, kids: 0 },
  { date: '2026-04-18', room: 'Pine', name: '김샘', path: '떠나요', nights: 1, price: 400000, adults: 0, kids: 0 },
  { date: '2026-04-24', room: 'Beach', name: '최랑희', phone: '01096886809', path: '네이버플레이스', nights: 2, price: 400000, adults: 0, kids: 0 },
  { date: '2026-04-25', room: 'Pine', name: '박기태', path: '여기어때', nights: 1, price: 400000, adults: 0, kids: 0 },
  { date: '2026-05-15', room: 'Beach', name: '박인희', phone: '01048307024', path: '네이버지도', nights: 2, price: 590000, adults: 0, kids: 0 },
  { date: '2026-05-23', room: 'Beach', name: '이현자', path: '여기어때', nights: 2, price: 600000, adults: 0, kids: 0 },
  { date: '2026-07-13', room: 'Pine', name: '천정봉', path: '여기어때', nights: 1, price: 300000, adults: 0, kids: 0 }
];
